  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>›</span>
        <span className="text-[#032738] font-medium">{course.title}</span>
      </div>
        ...
        <div className="flex-1 min-w-0">
                ...
                {!hasModules ? (
                  <>
                    ...
                    <button
                      ...
                      className="!bg-[#0A4A68] text-white px-6 py-2 !text-sm font-semibold hover:!bg-[#032738] transition-colors cursor-pointer"
                    >
          ...
          <div className="mt-6 flex flex-col lg:flex-row gap-6">
            <div className="flex-1">
              {activeLesson && (
                <>
                  <h2 className="text-xl font-bold text-[#032738]">
              ...
              {!activeLesson && !hasModules && (
                <div className="text-center py-8">
                  <h2 className="text-xl font-bold text-[#032738]">{course.title}</h2>
                  <p className="text-gray-500 text-sm mt-2">
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#032738]">{course.instructor.name}</p>
            ...
            {hasModules && (
              <div className="lg:w-72 shrink-0">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-sm font-bold text-[#032738] uppercase tracking-wider">Anotações</h3>
                  <button
        ...
        <div className="lg:w-80 shrink-0">
          <div className="bg-white border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm font-bold text-[#032738]">Conteúdo do Curso</h3>
                    ...
                    <div key={idx}>
                      ...
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <span className="!text-sm font-medium text-[#032738] truncate !p-0">{mod.title}</span>
                        </div>
                        <svg
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  <span className={`!text-sm block truncate !p-0 ${isActive ? "font-semibold text-[#032738]" : "text-gray-600"}`}>
                                    {lesson.title}
                                  </span>
                                </div>
            ...
            <div className="p-4 border-t border-gray-200">
              <button
                onClick={() => setShowModal(true)}
                className="w-full py-2 !text-sm font-semibold !bg-[#0A4A68] text-white hover:!bg-[#032738] transition-colors cursor-pointer flex items-center justify-center gap-2"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setShowModal(false)}>
          <div className="bg-white w-full max-w-lg mx-4 p-8 border border-gray-200 shadow-lg" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-[#032738]">Adicionar nova aula</h2>
              <button
            ...
            <form onSubmit={handleAulaSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 !text-sm font-semibold !bg-[#0A4A68] text-white hover:!bg-[#032738] transition-colors cursor-pointer disabled:opacity-50"
                >
