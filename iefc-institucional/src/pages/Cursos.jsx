...
export default function Cursos() {
  ...
  return (
    <DashboardLayout>
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-[#032738]">Cursos</h1>
      ...
      {activeCategory === "Todos" ? (
        Object.entries(grouped).map(([category, courses]) => (
          <div key={category} className="mb-10">
            <h2 className="text-xl font-bold text-[#032738] mb-4">{category}</h2>
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-[#032738] mb-1">Em Destaque</h2>
            ...
            {featured.slice(1, 3).map((course) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1 min-w-0">
                  <h3 className="text-sm font-semibold text-[#032738] leading-snug">{course.title}</h3>
