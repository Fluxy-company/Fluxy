...
export default function GerarRelatorio() {
    ...
    // ── Helpers de estilo (IEFC branding) ──
    const inputCls = "w-full border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:border-[#0A4A68]";
    const labelCls = "block text-xs font-medium text-gray-600 mb-1";
    const textaCls = `${inputCls} resize-none`;
    const btnNavy = "!bg-[#032738] text-white px-4 py-2 text-sm cursor-pointer hover:opacity-90";
    const btnTeal = "!bg-[#0A4A68] text-white px-4 py-2 text-sm cursor-pointer hover:opacity-90";
    ...
    return (
        <DashboardLayout>
            {/* Barra de progresso */}
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-[#032738]">Gerar Relatório de Atividades</h1>
                <div className="flex gap-1 mt-4 flex-wrap">
                    {STEPS.map((s, i) => (
                        <button key={i} onClick={() => setStep(i)}
                            className={`px-3 py-1 text-xs font-semibold border cursor-pointer
                                ${i === step ? "!bg-[#032738] text-white border-[#032738]"
                                    : i < step ? "!bg-[#0A4A68] text-white border-[#0A4A68]"
                ...
                <div className="space-y-6 max-w-2xl">
                    {[
                        ...
                        <div key={fotoKey} className={cardCls}>
                            <h3 className="font-bold text-[#032738] text-sm">{label}</h3>
                            <div>
            ...
            {step === 4 && (
                <div className="space-y-6 max-w-3xl">
                    ...
                    <div>
                        <h3 className="font-medium text-[#032738] text-sm mb-2">
            ...
            {step === 6 && (
                <div className="space-y-6 max-w-lg">
                    <div className="bg-gray-50 border p-5 space-y-2">
                        <h3 className="font-bold text-[#032738] text-sm">Resumo</h3>
