...
export default function DashboardNavbar() {
  ...
  return (
    <nav className="bg-[#032738] px-8 h-16 flex items-center justify-between sticky top-0 z-50 w-full">
      <div className="flex items-center gap-2">
        <span className="text-white font-bold text-lg tracking-wide">IEFC</span>
