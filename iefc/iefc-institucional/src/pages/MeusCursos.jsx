...
export default function MeusCursos() {
  ...
  return (
    <DashboardLayout>
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#032738]">Meus Cursos</h1>
      ...
      {/* Recommended Section */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-[#032738] mb-1">Recomendado para você</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="bg-white border border-gray-200 p-6 flex flex-col gap-2">
              ...
              <h3 className="text-xl font-bold text-[#032738]">
            ...
            <div className="bg-white border border-gray-200 p-6 flex flex-col gap-2 flex-1">
              <h3 className="text-xl font-bold text-[#032738]">Sobre o curso</h3>
