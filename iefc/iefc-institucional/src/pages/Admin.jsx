...
export default function Admin() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#032738]">Admin — Gerenciar Plataforma</h1>
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-2 bg-white border border-gray-200 p-8">
              <h2 className="text-xl font-bold text-[#032738] mb-6">Novo Curso</h2>
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-8 !bg-[#0A4A68] text-white px-8 py-3 !text-sm font-semibold hover:!bg-[#032738] transition-colors cursor-pointer disabled:opacity-50"
              >
            ...
            <div className="bg-white border border-gray-200 p-6 self-start">
              <h3 className="text-sm font-bold text-[#032738] uppercase tracking-wider mb-4">Pré-visualização</h3>
              ...
              <h4 className="text-lg font-bold text-[#032738] leading-snug">
                {form.titulo || "Título do curso"}
              </h4>
              <p className="text-sm text-gray-500 mt-1">{form.instrutor || "Nome do instrutor"}</p>
              <div className="flex flex-wrap gap-2 mt-3">
                {temasSelecionado && (
                  <span className="inline-block px-3 py-1 text-xs font-medium !bg-[#032738] text-white">
      ...
      {activeTab === "temas" && (
        <>
          ...
          <form onSubmit={handleCriarTema} className="bg-white border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold text-[#032738] mb-4">Adicionar Tema</h2>
            <div className="flex gap-4">
              ...
              <button
                ...
                className="!bg-[#0A4A68] text-white px-6 py-3 !text-sm font-semibold hover:!bg-[#032738] transition-colors cursor-pointer disabled:opacity-50"
              >
              ...
              return (
                <div key={tema.id} className="bg-white border border-gray-200 p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-bold text-[#032738]">{tema.nome}</h3>
                    ...
                    <ul className="space-y-2">
                      {cursosNoTema.map((curso) => (
                        <li key={curso.id} className="flex items-center gap-2 text-sm text-gray-600">
                          <span className="w-1.5 h-1.5 bg-[#032738] shrink-0" />
