  ...
  return (
    <div className="bg-white overflow-hidden flex flex-row shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-4 flex flex-col gap-2 flex-1 min-w-0">
        ...
        <h3 className="text-sm font-semibold text-[#032738] leading-snug">{title}</h3>
        ...
        <div className="mt-auto pt-1">
          <button
            onClick={onClick}
            className="!bg-[#0A4A68] hover:!bg-[#032738] text-white text-xs font-semibold px-4 py-2 transition-colors cursor-pointer"
          >
